...
PlayerResource.prototype.meta = function(playerKey, cb) {
  ...
  this
    .callGetRequest('https://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/metadata?format=json')
    .then(function(data) {
...
PlayerResource.prototype.stats = function(playerKey, cb) {
  ...
  this
    .callGetRequest('https://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/stats?format=json')
    .then(function(data) {
...
PlayerResource.prototype.percent_owned = function(playerKey, cb) {
  ...
  this
    .callGetRequest('https://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/percent_owned?format=json')
    .then(function(data) {
...
PlayerResource.prototype.ownership = function(playerKey, leagueKey, cb) {
  ...
  this
    .callGetRequest('https://fantasysports.yahooapis.com/fantasy/v2/league/' + leagueKey + '/players;player_keys=' + playerKey + '/ownership?format=json')
    .then(function(data) {
...
PlayerResource.prototype.draft_analysis = function(playerKey, cb) {
  ...
  this
    .callGetRequest('https://fantasysports.yahooapis.com/fantasy/v2/player/' + playerKey + '/draft_analysis?format=json')
    .then(function(data) {
